...
public class WsContainerSingle {
    ...
    public static WsContainer build(SerializeManager serializeManager, WsTsPortHandle wsTsPortHandle, WsSessionGroupManager wsSessionGroupManager) {
        if (wsContainer == null) {
            synchronized (WsContainerSingle.class) {
                if (wsContainer == null) {
                    wsContainer = new WsContainer();
                    ...
                    wsContainer.setWsSessionGroupManager(wsSessionGroupManager);
                }
            }
        }
        return wsContainer;
